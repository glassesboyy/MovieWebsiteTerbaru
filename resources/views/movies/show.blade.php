...
<head>
    ...
    <title>Detail Film - MovieZul</title>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="max-w-4xl mx-auto">
                    <div class="bg-black/30 backdrop-blur-sm rounded-lg shadow-lg p-6">
                        <h3 class="text-2xl font-bold text-center text-white mb-6">Detail Film</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="md:col-span-2 text-white">
                                <div class="space-y-4">
                                    <div>
                                        <h4 class="text-lg font-semibold text-purple-400">Judul Film</h4>
                                        <p class="mt-1">{{ $movie->movie_title }}</p>
                                    </div>

                                    <div>
                                        <h4 class="text-lg font-semibold text-purple-400">Deskripsi</h4>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <h4 class="text-lg font-semibold text-purple-400">Tanggal Rilis</h4>
                                            <p class="mt-1">{{ $movie->release_date }}</p>
                                        </div>

                                        <div>
                                            <h4 class="text-lg font-semibold text-purple-400">Waktu Tayang</h4>
                                            <p class="mt-1">{{ $movie->show_time }}</p>
                                        </div>

                                        <div>
                                            <h4 class="text-lg font-semibold text-purple-400">Harga</h4>
                                            <p class="mt-1">{{ 'Rp ' . number_format($movie->price, 2, ',', '.') }}
                                            </p>
                                        </div>

                                        <div>
                                            <h4 class="text-lg font-semibold text-purple-400">Kursi Tersedia</h4>
                                            <p class="mt-1">{{ $movie->available_seats }} kursi</p>
                                        </div>
                                    </div>
                                </div>
